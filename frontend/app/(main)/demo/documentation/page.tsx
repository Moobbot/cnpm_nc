...
`}</code>
                        ...
                        <ul className="line-height-3">
                            ...
                            <li>
                                <span className="text-primary font-medium">public/demo_theme/utilities</span>: Assets used in demos
                            </li>
                            <li>
                                <span className="text-primary font-medium">public/layout</span>: Assets used in layout such as a logo
                            </li>
                            <li>
                                <span className="text-primary font-medium">styles/demo_theme/utilities</span>: Styles used in demos only
                            </li>
                            <li>
