...
const MenuDemo = ({ children }: any) => {
    ...
    const wizardItems = [
        { label: 'Personal', command: () => router.push('/demo/uikit/menu') },
        { label: 'Seat', command: () => router.push('/demo/uikit/menu/seat') },
        { label: 'Payment', command: () => router.push('/demo/uikit/menu/payment') },
        {
            label: 'Confirmation',
            command: () => router.push('/demo/uikit/menu/confirmation')
        }
    ];
